...
export type DisasterType = 'EARTHQUAKE' | 'FLOOD' | 'LANDSLIDE' | 'FOREST_FIRE' | 'STORM' | 'OTHER';
export type SeverityLevel = 'LOW' | 'MODERATE' | 'HIGH' | 'CRITICAL';
export type DisasterEventStatus = 'DETECTED' | 'ANALYZING' | 'CONFIRMED' | 'NOTIFYING' | 'RESOLVED';
export type AlertStatus = 'NOTIFYING' | 'WAITING_RESPONSE' | 'SAFE' | 'UNSAFE' | 'NO_RESPONSE' | 'ESCALATED';
export type CitizenSafetyStatus = 'SAFE' | 'UNSAFE' | 'NO_RESPONSE' | 'UNKNOWN';
export type UrgencyLevel = 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL';
export type UserRole = 'CITIZEN' | 'RESPONDER' | 'RESCUE_TEAM' | 'AUTHORITY' | 'ADMIN' | 'SUPER_ADMIN';
export type SOSStatus = 'PENDING' | 'ACKNOWLEDGED' | 'ASSIGNED' | 'IN_PROGRESS' | 'RESOLVED' | 'CANCELLED';
export type MedicalUrgency = 'NONE' | 'MINOR' | 'SEVERE' | 'CRITICAL';
export type RescueTeamType = 'ARMY' | 'POLICE' | 'RED_CROSS' | 'FIRE_DEPARTMENT' | 'LOCAL_VOLUNTEER';
export type RescueTeamStatus = 'AVAILABLE' | 'DISPATCHED' | 'ON_SITE' | 'RESTING' | 'OFFLINE';
export type ReportStatus = 'SUBMITTED' | 'UNDER_REVIEW' | 'VERIFIED' | 'REJECTED' | 'RESOLVED';
